...
public void setup() {
  ...
  String numero1_ingresado = input("Ingresa el primer número:");
  num1 = float(numero1_ingresado);

  String numero2_ingresado = input("Ingresa el segundo número:");
  ...
  if (num2 == 0) {
    println("la dision por cero no se define");
  }
